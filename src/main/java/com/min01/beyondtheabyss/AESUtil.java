...
public class AESUtil
{
    ...
    private static final String MASTER_KEY = "FM(QWO(E(DJ##((SL!_#@_RKF";
    private static final String SALT = "MCMDW(F(E((()Q)BTA_)R))Deofm0ew0w0E))@e";
    public static final String HEADER = "LOVELBTA";
