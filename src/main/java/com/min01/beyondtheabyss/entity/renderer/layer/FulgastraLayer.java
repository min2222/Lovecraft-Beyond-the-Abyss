...
public class FulgastraLayer extends GlowingLayer<FulgastraEntity, FulgastraModel>
{
	...
	public FulgastraLayer(RenderLayerParent<FulgastraEntity, FulgastraModel> renderer, FulgastraModel model) 
	{
		super(renderer, model, null);
	}

	@Override
	public void render(PoseStack poseStack, MultiBufferSource bufferIn, int packedLightIn, FulgastraEntity entity, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch)
	{
