...
public class MutavoreRenderer extends MobRenderer<EntityMutavore, ModelMutavore>
{
	...
	{
		super(pContext, new ModelMutavore(pContext.bakeLayer(ModelMutavore.LAYER_LOCATION)), 0.5F);
	}
	
	@Override
	public void render(EntityMutavore pEntity, float pEntityYaw, float pPartialTicks, PoseStack pPoseStack, MultiBufferSource pBuffer, int pPackedLight)
	{
	...
	@Override
	public ResourceLocation getTextureLocation(EntityMutavore pEntity) 
	{
