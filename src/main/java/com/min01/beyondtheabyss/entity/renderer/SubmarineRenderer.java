...
public class SubmarineRenderer extends EntityRenderer<EntitySubmarine>
{
	...
	public void render(EntitySubmarine p_114485_, float p_114486_, float p_114487_, PoseStack p_114488_, MultiBufferSource p_114489_, int p_114490_)
	{
		...
		float yRot = f2;
		Vec3 detectorPos = BTAClientUtil.getWorldPositionOfMultiPart(p_114485_, yRot, this.model.root(), new String[] {"submarine"});
		Vec3 topPos = BTAClientUtil.getWorldPositionOfMultiPart(p_114485_, yRot, this.model.root(), new String[] {"submarine", "top"});
		Vec3 leftWallPos = BTAClientUtil.getWorldPositionOfMultiPart(p_114485_, yRot, this.model.root(), new String[] {"submarine", "l_wall"});
		Vec3 rightWallPos = BTAClientUtil.getWorldPositionOfMultiPart(p_114485_, yRot, this.model.root(), new String[] {"submarine", "r_wall"});
		Vec3 hatchPos = BTAClientUtil.getWorldPositionOfMultiPart(p_114485_, yRot, this.model.root(), new String[] {"submarine", "hatch"});
		Vec3 frontPos = BTAClientUtil.getWorldPositionOfMultiPart(p_114485_, yRot, this.model.root(), new String[] {"submarine", "front"});
		Vec3 backPos = BTAClientUtil.getWorldPositionOfMultiPart(p_114485_, yRot, this.model.root(), new String[] {"submarine", "back"});
		Vec3 bottomPos = BTAClientUtil.getWorldPositionOfMultiPart(p_114485_, yRot, this.model.root(), new String[] {"submarine", "bottom"});
		Vec3 seat4Pos = BTAClientUtil.getWorldPositionOfMultiPart(p_114485_, yRot, this.model.root(), new String[] {"submarine", "seat4"});
		Vec3 seat3Pos = BTAClientUtil.getWorldPositionOfMultiPart(p_114485_, yRot, this.model.root(), new String[] {"submarine", "seat3"});
		Vec3 seat2Pos = BTAClientUtil.getWorldPositionOfMultiPart(p_114485_, yRot, this.model.root(), new String[] {"submarine", "seat2"});
		Vec3 seat1Pos = BTAClientUtil.getWorldPositionOfMultiPart(p_114485_, yRot, this.model.root(), new String[] {"submarine", "seat1"});
		Vec3 controllerPos = BTAClientUtil.getWorldPositionOfMultiPart(p_114485_, yRot, this.model.root(), new String[] {"submarine", "controller"});
