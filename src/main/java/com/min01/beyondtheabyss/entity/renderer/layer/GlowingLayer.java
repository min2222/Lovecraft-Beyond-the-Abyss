...
public class GlowingLayer<T extends LivingEntity, M extends EntityModel<T>> extends RenderLayer<T, M>
{
	...
	{
		this.coloredGlowingModelCopyLayerRender(this.getParentModel(), this.model, this.texture, p_117349_, p_117350_, p_117351_, p_117352_, p_117353_, p_117354_, p_117356_, p_117357_, p_117358_, p_117355_, 1.0F, 1.0F, 1.0F);
	}
	...
	{
		VertexConsumer vertexconsumer = p_117380_.getBuffer(this.getRenderType(p_117378_));
		p_117377_.renderToBuffer(p_117379_, vertexconsumer, p_117381_, LivingEntityRenderer.getOverlayCoords(p_117382_, 0.0F), p_117383_, p_117384_, p_117385_, this.getAlpha(p_117382_));
	}
	
	public RenderType getRenderType(ResourceLocation texture)
	{
		return BTARenderType.eyesFix(texture);
	}
