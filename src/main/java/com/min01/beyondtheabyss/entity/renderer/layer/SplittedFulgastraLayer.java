...
public class SplittedFulgastraLayer extends GlowingLayer<SplittedFulgastraEntity, SplittedFulgastraModel>
{
	...
	public SplittedFulgastraLayer(RenderLayerParent<SplittedFulgastraEntity, SplittedFulgastraModel> renderer, SplittedFulgastraModel model) 
	{
		super(renderer, model, null);
	}

	@Override
	public void render(PoseStack poseStack, MultiBufferSource bufferIn, int packedLightIn, SplittedFulgastraEntity entity, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch)
	{
