...
public class ThrownHarpoonRenderer extends EntityRenderer<EntityThrownHarpoon>
{
	private ModelHarpoon model;
	private ModelGhidruthHarpoon modelGhidruth;
	   
	public ThrownHarpoonRenderer(Context p_174008_)
	{
		super(p_174008_);
		this.model = new ModelHarpoon(p_174008_.bakeLayer(ModelHarpoon.LAYER_LOCATION));
		this.modelGhidruth = new ModelGhidruthHarpoon(p_174008_.bakeLayer(ModelGhidruthHarpoon.LAYER_LOCATION));
	}
	...
	public Model getModel(EntityThrownHarpoon harpoon) 
	{
		return !harpoon.isReinforced() ? this.model : this.modelGhidruth;
	}
