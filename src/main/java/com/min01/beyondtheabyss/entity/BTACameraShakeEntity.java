...
public class BTACameraShakeEntity extends Entity 
{
	private static final EntityDataAccessor<Float> RADIUS = SynchedEntityData.defineId(BTACameraShakeEntity.class, EntityDataSerializers.FLOAT);
    private static final EntityDataAccessor<Float> MAGNITUDE = SynchedEntityData.defineId(BTACameraShakeEntity.class, EntityDataSerializers.FLOAT);
    private static final EntityDataAccessor<Integer> DURATION = SynchedEntityData.defineId(BTACameraShakeEntity.class, EntityDataSerializers.INT);
    private static final EntityDataAccessor<Integer> FADE_DURATION = SynchedEntityData.defineId(BTACameraShakeEntity.class, EntityDataSerializers.INT);

    public BTACameraShakeEntity(EntityType<?> type, Level world) 
    {
        super(type, world);
    }

    public BTACameraShakeEntity(Level world, Vec3 position, float radius, float magnitude, int duration, int fadeDuration) 
    {
    ...
    {
        if(!world.isClientSide && BTAConfig.cameraShakes.get()) 
        {
            BTACameraShakeEntity cameraShake = new BTACameraShakeEntity(world, position, radius, magnitude, duration, fadeDuration);
