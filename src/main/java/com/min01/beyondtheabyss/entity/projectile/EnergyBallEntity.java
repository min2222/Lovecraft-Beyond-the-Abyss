...
{
	public EnergyBallEntity(EntityType<? extends EnergyBallEntity> pEntityType, Level pLevel) 
	{
		super(pEntityType, pLevel);
		this.setNoGravity(true);
	}

	public EnergyBallEntity(Level pLevel, LivingEntity pShooter) 
	{
		super(BTAEntities.ENERGY_BALL.get(), pShooter, pLevel);
		this.setNoGravity(true);
	}

	public EnergyBallEntity(Level pLevel, double pX, double pY, double pZ)
	{
