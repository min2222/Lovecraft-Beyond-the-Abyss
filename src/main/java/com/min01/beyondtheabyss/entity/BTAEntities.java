...
public class BTAEntities
{
	...
	public static final RegistryObject<EntityType<EntityFishBait>> FISH_BAIT = registerEntity("fish_bait", createBuilder(EntityFishBait::new, MobCategory.MISC).sized(0.5F, 0.4F));
