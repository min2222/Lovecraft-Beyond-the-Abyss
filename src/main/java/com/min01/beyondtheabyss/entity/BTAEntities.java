...
public class BTAEntities
{
	...
	public static final RegistryObject<EntityType<EntitySiamserpentHead>> SIAMSERPENT_HEAD = registerEntity("siamserpent_head", createBuilder(EntitySiamserpentHead::new, MobCategory.WATER_CREATURE).sized(1.0F, 1.0F).clientTrackingRange(100));
 	public static final RegistryObject<EntityType<EntitySiamserpentBone>> SIAMSERPENT_BONE = registerEntity("siamserpent_bone", createBuilder(EntitySiamserpentBone::new, MobCategory.WATER_CREATURE).sized(1.0F, 1.0F).clientTrackingRange(100));
	...
	public static final RegistryObject<EntityType<EntityLithoshrimp>> LITHOSHRIMP = registerEntity("lithoshrimp", createBuilder(EntityLithoshrimp::new, MobCategory.WATER_CREATURE).sized(0.5625F, 0.4375F));
	public static final RegistryObject<EntityType<EntityForneusHead>> FORNEUS_HEAD = registerEntity("forneus_head", createBuilder(EntityForneusHead::new, MobCategory.WATER_CREATURE).sized(4.0F, 4.0F).clientTrackingRange(100));
	public static final RegistryObject<EntityType<EntityForneusBody>> FORNEUS_BODY = registerEntity("forneus_body", createBuilder(EntityForneusBody::new, MobCategory.WATER_CREATURE).sized(4.0F, 4.0F).clientTrackingRange(100));
	public static final RegistryObject<EntityType<EntityForneusTail>> FORNEUS_TAIL = registerEntity("forneus_tail", createBuilder(EntityForneusTail::new, MobCategory.WATER_CREATURE).sized(4.0F, 4.0F).clientTrackingRange(100));
	...
	public static final RegistryObject<EntityType<EntityDuneDevourerHead>> DUNE_DEVOURER_HEAD = registerEntity("dune_devourer_head", createBuilder(EntityDuneDevourerHead::new, MobCategory.MONSTER).sized(5.0F, 6.25F).fireImmune().clientTrackingRange(100));
	public static final RegistryObject<EntityType<EntityDuneDevourerBody>> DUNE_DEVOURER_BODY = registerEntity("dune_devourer_body", createBuilder(EntityDuneDevourerBody::new, MobCategory.MONSTER).sized(5.0F, 6.25F).fireImmune().clientTrackingRange(100));
	public static final RegistryObject<EntityType<EntityDuneDevourerTail>> DUNE_DEVOURER_TAIL = registerEntity("dune_devourer_tail", createBuilder(EntityDuneDevourerTail::new, MobCategory.MONSTER).sized(5.0F, 6.25F).fireImmune().clientTrackingRange(100));
