...
public abstract class AbstractBTAFlyingCreature extends AbstractAnimatableFlyingCreature implements IMultipart
{
	public static final EntityDataAccessor<Vec3> LAST_LOOK_POS = SynchedEntityData.defineId(AbstractBTAFlyingCreature.class, BTAEntityDataSerializers.VEC3.get());
	
	public final EntityPartBuilder<? extends AbstractBTAFlyingCreature> partBuilder;
	
	public AbstractBTAFlyingCreature(EntityType<? extends AbstractAnimatableFlyingCreature> pEntityType, Level pLevel)
	{
	...
	protected void registerGoals() 
	{
        ...
        if(this.getBTAMobType().alwaysHostile)
        {
            this.targetSelector.addGoal(0, new NearestAttackableTargetGoal<>(this, Player.class, false, false)
            {
            	...
            	{
            		return AbstractBTAFlyingCreature.this.getTargetSearchArea(pTargetDistance);
            	}
            });
        }
	...
	public abstract EntityPartBuilder<? extends AbstractBTAFlyingCreature> createBuilder();
