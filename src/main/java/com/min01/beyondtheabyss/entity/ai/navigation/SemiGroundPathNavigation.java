...
public class SemiGroundPathNavigation extends GroundPathNavigation
{
	public float distanceModifier = 0.75F;
	
	public SemiGroundPathNavigation(Mob pMob, Level pLevel)
	{
		super(pMob, pLevel);
	}
	
	public SemiGroundPathNavigation(Mob pMob, Level pLevel, float distanceModifier)
	{
		super(pMob, pLevel);
