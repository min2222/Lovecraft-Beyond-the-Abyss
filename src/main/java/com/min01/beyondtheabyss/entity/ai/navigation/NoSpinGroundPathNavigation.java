...
public class NoSpinGroundPathNavigation extends GroundPathNavigation 
{
    ...
    public NoSpinGroundPathNavigation(Mob entitylivingIn, Level worldIn) 
    {
        super(entitylivingIn, worldIn);
    }

    public NoSpinGroundPathNavigation(Mob entitylivingIn, Level worldIn, float distancemodifier)
    {
        super(entitylivingIn, worldIn);
