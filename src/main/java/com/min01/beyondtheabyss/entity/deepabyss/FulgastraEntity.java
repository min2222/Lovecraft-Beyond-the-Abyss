...
public class FulgastraEntity extends AbstractBTAMonster
{
	public static final EntityDataAccessor<Boolean> IS_SPLIT = SynchedEntityData.defineId(FulgastraEntity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<Boolean> IS_CHARGED = SynchedEntityData.defineId(FulgastraEntity.class, EntityDataSerializers.BOOLEAN);
	...
	public FulgastraEntity(EntityType<? extends AbstractBTAMonster> pEntityType, Level pLevel)
	{
	...
	public static boolean checkFulgastraSpawnRules(EntityType<? extends AbstractBTAMonster> pType, ServerLevelAccessor pServerLevel, MobSpawnType pSpawnType, BlockPos pPos, RandomSource pRandom) 
    {
