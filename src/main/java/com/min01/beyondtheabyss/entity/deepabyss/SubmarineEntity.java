...
public class SubmarineEntity extends AbstractOwnableEntity<LivingEntity> implements IMultipart, IDynamicLightEntity
{
	...
	public static final EntityDataAccessor<Integer> ANIMATION_TICK = SynchedEntityData.defineId(SubmarineEntity.class, EntityDataSerializers.INT);
	...
	public SubmarineEntity(EntityType<? extends Entity> pEntityType, Level pLevel)
	{
