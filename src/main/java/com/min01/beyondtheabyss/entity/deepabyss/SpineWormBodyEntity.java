...
public class SpineWormBodyEntity extends AbstractSpineWormPart
{
	public SpineWormBodyEntity(EntityType<? extends AbstractSpineWormPart> pEntityType, Level pLevel) 
	{
