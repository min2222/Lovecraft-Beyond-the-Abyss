...
public class ChainTrapMawEntity extends Entity
{
	public static final EntityDataAccessor<BlockPos> TRAP_POS = SynchedEntityData.defineId(ChainTrapMawEntity.class, EntityDataSerializers.BLOCK_POS);
	public static final EntityDataAccessor<Optional<UUID>> TARGET_UUID = SynchedEntityData.defineId(ChainTrapMawEntity.class, EntityDataSerializers.OPTIONAL_UUID);
	public static final EntityDataAccessor<Integer> CHAIN_LENGTH = SynchedEntityData.defineId(ChainTrapMawEntity.class, EntityDataSerializers.INT);
	public KinematicChain chain;
	
	public ChainTrapMawEntity(EntityType<?> pEntityType, Level pLevel)
	{
