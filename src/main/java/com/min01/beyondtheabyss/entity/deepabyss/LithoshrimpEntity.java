...
public class LithoshrimpEntity extends AbstractBTACreature
{
	...
	public static boolean checkLithoshrimpSpawnRules(EntityType<? extends AbstractBTACreature> pType, ServerLevelAccessor pServerLevel, MobSpawnType pSpawnType, BlockPos pPos, RandomSource pRandom) 
    {
