...
public class NecroshellEntity extends AbstractBTACreature
{
	public static final EntityDataAccessor<Integer> SHELL_TYPE = SynchedEntityData.defineId(NecroshellEntity.class, EntityDataSerializers.INT);
	...
	public void registerDefaultGoals()
	{
		this.goalSelector.addGoal(0, new RandomStrollGoal(this, 1.25F)
		{
			...
			{
				return super.canUse() && NecroshellEntity.this.canMoveAround();
			}
		});
	}
	...
	public static boolean checkNecroshellSpawnRules(EntityType<? extends AbstractBTACreature> pType, ServerLevelAccessor pServerLevel, MobSpawnType pSpawnType, BlockPos pPos, RandomSource pRandom) 
    {
