...
import com.min01.beyondtheabyss.entity.AbstractBTAMonster2;
...
public abstract class AbstractDeepAbyssMonster2 extends AbstractBTAMonster2
{
	public AbstractDeepAbyssMonster2(EntityType<? extends Monster> p_21683_, Level p_21684_) 
	{
    ...
    protected void registerGoals() 
    {
    	...
    	if(this.isSwimable())
    	{
            this.goalSelector.addGoal(4, new RandomSwimmingGoal(this, this.getAttributeBaseValue(Attributes.MOVEMENT_SPEED), 20)
            {
            	...
            	{
            		return AbstractDeepAbyssMonster2.this.canRandomSwim() && super.canUse();
            	}
            });
    	}
    }
