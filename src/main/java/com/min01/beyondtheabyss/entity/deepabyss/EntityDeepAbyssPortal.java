...
{
	public static final EntityDataAccessor<Integer> ANIMATION_STATE = SynchedEntityData.defineId(EntityDeepAbyssPortal.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Integer> ANIMATION_TICK = SynchedEntityData.defineId(EntityDeepAbyssPortal.class, EntityDataSerializers.INT);
	
	public final EntityPartBuilder<EntityDeepAbyssPortal> partBuilder;
	
	public final SmoothAnimationState idleAnimationState = new SmoothAnimationState();
	public final SmoothAnimationState openAnimationState = new SmoothAnimationState();
	
	public EntityDeepAbyssPortal(EntityType<?> pEntityType, Level pLevel)
	{
