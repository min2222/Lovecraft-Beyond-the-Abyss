...
public abstract class AbstractBTAMonster2 extends Monster implements IAnimatable, IPosArray
{
	public static final EntityDataAccessor<Integer> ANIMATION_STATE = SynchedEntityData.defineId(AbstractBTAMonster2.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Integer> ANIMATION_TICK = SynchedEntityData.defineId(AbstractBTAMonster2.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Integer> PREV_ANIMATION_TICK = SynchedEntityData.defineId(AbstractBTAMonster2.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Integer> MOVE_STOP_DELAY = SynchedEntityData.defineId(AbstractBTAMonster2.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Boolean> CAN_LOOK = SynchedEntityData.defineId(AbstractBTAMonster2.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<Boolean> CAN_MOVE = SynchedEntityData.defineId(AbstractBTAMonster2.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<Boolean> IS_USING_SKILL = SynchedEntityData.defineId(AbstractBTAMonster2.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<Boolean> HAS_TARGET = SynchedEntityData.defineId(AbstractBTAMonster2.class, EntityDataSerializers.BOOLEAN);

	public Vec3[] posArray;
	
	public AbstractBTAMonster2(EntityType<? extends Monster> p_21683_, Level p_21684_)
	{
