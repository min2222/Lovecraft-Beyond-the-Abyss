...
public abstract class AbstractAnimatableWaterCreature extends AbstractWaterCreature implements IAnimatable
{
	...
	public void registerDefaultGoals()
	{
		this.goalSelector.addGoal(0, new WaterAvoidingRandomStrollGoal(this, 1.0F)
		{
			...
			{
				return super.canUse() && AbstractAnimatableWaterCreature.this.canMoveAround() && !AbstractAnimatableWaterCreature.this.isInWater();
			}
		});
		this.goalSelector.addGoal(0, new RandomSwimmingGoal(this, 1.0F, 60)
		{
			...
			public boolean canUse()
			{
				return super.canUse() && AbstractAnimatableWaterCreature.this.canMoveAround();
			}
		});
	}
