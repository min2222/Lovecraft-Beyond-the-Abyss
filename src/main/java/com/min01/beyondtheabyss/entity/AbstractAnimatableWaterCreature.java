...
public abstract class AbstractAnimatableWaterCreature extends AbstractWaterCreature implements IAnimatable
{
	public static final EntityDataAccessor<Integer> ANIMATION_STATE = SynchedEntityData.defineId(AbstractAnimatableWaterCreature.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Integer> ANIMATION_TICK = SynchedEntityData.defineId(AbstractAnimatableWaterCreature.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Integer> STOP_LOOK_TICK = SynchedEntityData.defineId(AbstractAnimatableWaterCreature.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Integer> STOP_MOVE_TICK = SynchedEntityData.defineId(AbstractAnimatableWaterCreature.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Boolean> IS_TARGET_VALID = SynchedEntityData.defineId(AbstractAnimatableWaterCreature.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<Boolean> IS_ANIMATION_PLAYING = SynchedEntityData.defineId(AbstractAnimatableWaterCreature.class, EntityDataSerializers.BOOLEAN);

	public Vec3[] posArray;
	
	public AbstractAnimatableWaterCreature(EntityType<? extends AbstractWaterCreature> pEntityType, Level pLevel)
	{
	...
	public void registerDefaultGoals()
	{
		this.goalSelector.addGoal(0, new RandomStrollGoal(this, 1.0F, this.getMoveInterval())
		{
			...
			{
				if(super.canUse() && AbstractAnimatableWaterCreature.this.canMoveAround())
				{
					return !AbstractAnimatableWaterCreature.this.isInWater() || !AbstractAnimatableWaterCreature.this.isSwim();
				}
				return false;
			}
			...
			{
				Vec2 radius = AbstractAnimatableWaterCreature.this.getMoveRadius();
		...
		this.goalSelector.addGoal(0, new RandomSwimmingGoal(this, 1.0F, this.getSwimInterval())
		{
			...
			protected Vec3 getPosition()
			{
				Vec2 radius = AbstractAnimatableWaterCreature.this.getSwimRadius();
