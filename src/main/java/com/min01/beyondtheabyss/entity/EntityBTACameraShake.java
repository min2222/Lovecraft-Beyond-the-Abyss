...
public class EntityBTACameraShake extends Entity 
{
	private static final EntityDataAccessor<Float> RADIUS = SynchedEntityData.defineId(EntityBTACameraShake.class, EntityDataSerializers.FLOAT);
    private static final EntityDataAccessor<Float> MAGNITUDE = SynchedEntityData.defineId(EntityBTACameraShake.class, EntityDataSerializers.FLOAT);
    private static final EntityDataAccessor<Integer> DURATION = SynchedEntityData.defineId(EntityBTACameraShake.class, EntityDataSerializers.INT);
    private static final EntityDataAccessor<Integer> FADE_DURATION = SynchedEntityData.defineId(EntityBTACameraShake.class, EntityDataSerializers.INT);

    public EntityBTACameraShake(EntityType<?> type, Level world) 
    {
        super(type, world);
    }
