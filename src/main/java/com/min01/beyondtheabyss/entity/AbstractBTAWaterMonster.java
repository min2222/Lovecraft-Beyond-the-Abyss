...
{
	public static final EntityDataAccessor<Vec3> LAST_LOOK_POS = SynchedEntityData.defineId(AbstractBTAWaterMonster.class, BTAEntityDataSerializers.VEC3.get());
	
	public final EntityPartBuilder<? extends AbstractBTAWaterMonster> partBuilder;
	
	public AbstractBTAWaterMonster(EntityType<? extends AbstractAnimatableWaterMonster> pEntityType, Level pLevel)
	{
