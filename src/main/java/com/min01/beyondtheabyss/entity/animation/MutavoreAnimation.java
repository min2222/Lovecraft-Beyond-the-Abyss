...
{
	public static final AnimationDefinition MUTAVORE_MOUTH_OPENING = AnimationDefinition.Builder.withLength(0.25F)
			...
			.addAnimation("tongue", new AnimationChannel(AnimationChannel.Targets.POSITION, 
				...
				new Keyframe(0.25F, KeyframeAnimations.posVec(0.0F, 0.0F, -20.0F), AnimationChannel.Interpolations.CATMULLROM)
			))
			.build();

		public static final AnimationDefinition MUTAVORE_MOUTH_OPEN = AnimationDefinition.Builder.withLength(0.25F).looping()
			.addAnimation("upper_jaw", new AnimationChannel(AnimationChannel.Targets.ROTATION, 
				new Keyframe(0.0F, KeyframeAnimations.degreeVec(-30.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
				new Keyframe(0.0833F, KeyframeAnimations.degreeVec(-30.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
				new Keyframe(0.125F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
			...
			.addAnimation("tongue", new AnimationChannel(AnimationChannel.Targets.POSITION, 
				new Keyframe(0.0F, KeyframeAnimations.posVec(0.0F, 0.0F, -20.0F), AnimationChannel.Interpolations.CATMULLROM)
			))
			.build();
