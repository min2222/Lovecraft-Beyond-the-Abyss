...
public class FallingStoneEntity extends ThrowableProjectile
{
	public static final EntityDataAccessor<BlockState> BLOCK_STATE = SynchedEntityData.defineId(FallingStoneEntity.class, EntityDataSerializers.BLOCK_STATE);
	public static final EntityDataAccessor<Float> ROTATION = SynchedEntityData.defineId(FallingStoneEntity.class, EntityDataSerializers.FLOAT);
	public static final EntityDataAccessor<Integer> DELAY = SynchedEntityData.defineId(FallingStoneEntity.class, EntityDataSerializers.INT);
	
	public FallingStoneEntity(EntityType<? extends ThrowableProjectile> pEntityType, Level pLevel) 
	{
