...
public class EnergyBallModel extends EntityModel<EnergyBallEntity>
{
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(BeyondtheAbyss.MODID, "energy_ball"), "main");
	private final ModelPart root;

	public EnergyBallModel(ModelPart root)
	{
	...
	@Override
	public void setupAnim(EnergyBallEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) 
	{
