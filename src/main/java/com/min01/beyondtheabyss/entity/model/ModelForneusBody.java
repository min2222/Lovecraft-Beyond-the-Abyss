...
public class ModelForneusBody extends HierarchicalModel<EntityForneusBody>
{
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(BeyondtheAbyss.MODID, "forneus_body"), "main");
	private final ModelPart root;
	private final ModelPart body;

	public ModelForneusBody(ModelPart root)
	{
	...
	@Override
	public void setupAnim(EntityForneusBody entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) 
	{
