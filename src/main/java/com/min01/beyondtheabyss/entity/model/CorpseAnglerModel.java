...
public class CorpseAnglerModel extends HierarchicalModel<CorpseAnglerEntity>
{
	...
	public CorpseAnglerModel(ModelPart root)
	{
	...
	@Override
	public void setupAnim(CorpseAnglerEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch)
	{
