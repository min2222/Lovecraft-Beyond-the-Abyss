...
public class MysteriousGuyModel extends HierarchicalModel<MysteriousGuyEntity>
{
	...
	public MysteriousGuyModel(ModelPart root)
	{
	...
	@Override
	public void setupAnim(MysteriousGuyEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) 
	{
