...
public class ModelSiamserpentSlasher extends HierarchicalModel<EntitySiamserpentHead>
{
	...
	private final ModelPart SiamserpentSlasher;

	public ModelSiamserpentSlasher(ModelPart root) 
	{
		this.SiamserpentSlasher = root.getChild("SiamserpentSlasher");
	}
	...
	public static LayerDefinition createBodyLayer()
	{
		...
		partdefinition.addOrReplaceChild("SiamserpentSlasher", CubeListBuilder.create().texOffs(0, 53).addBox(-7.0F, -4.3333F, -3.9167F, 14.0F, 10.0F, 23.0F, new CubeDeformation(0.0F))
		...
		.texOffs(0, 0).addBox(-11.0F, -2.3333F, -31.9167F, 22.0F, 0.0F, 28.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 13.3333F, -7.5833F));
	...
	public void setupAnim(EntitySiamserpentHead entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) 
	{
		...
		BTAClientUtil.animateHead(this.SiamserpentSlasher, netHeadYaw, headPitch);
	}

	@Override
	public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) 
	{
		SiamserpentSlasher.render(poseStack, vertexConsumer, packedLight, packedOverlay, red, green, blue, alpha);
	}
	
	@Override
	public ModelPart root() 
	{
		return this.SiamserpentSlasher;
	}
}