...
public class DuneDevourerBodyModel extends HierarchicalModel<DuneDevourerBodyEntity>
{
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(BeyondtheAbyss.MODID, "dune_devourer_body"), "main");
	private final ModelPart root;
	private final ModelPart dune_devourer;

	public DuneDevourerBodyModel(ModelPart root)
	{
	...
	public static LayerDefinition createBodyLayer() 
	{
		...
		dune_devourer.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(0, 180).addBox(-100.0F, -2.0F, -40.0F, 200.0F, 100.0F, 80.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -40.0F, -50.0F, 1.5708F, 0.0F, 0.0F));

		return LayerDefinition.create(meshdefinition, 1024, 1024);
	}

	@Override
	public void setupAnim(DuneDevourerBodyEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch)
	{
