...
public class ModelSiamserpentBone extends HierarchicalModel<EntitySiamserpentBone> 
{
	...
	public static LayerDefinition createBodyLayer() 
	{
		...
		SiamserpentBone.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(0, 46).mirror().addBox(-12.0F, 0.0F, -7.0F, 12.0F, 0.0F, 13.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-9.0F, -4.042F, 0.2857F, 0.0F, 0.0F, 0.6109F));

		SiamserpentBone.addOrReplaceChild("cube_r4", CubeListBuilder.create().texOffs(0, 46).addBox(0.0F, 0.0F, -7.0F, 12.0F, 0.0F, 13.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(9.0F, -4.042F, 0.2857F, 0.0F, 0.0F, -0.6109F));
