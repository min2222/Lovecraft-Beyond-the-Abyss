...
{
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(BeyondtheAbyss.MODID, "overseer"), "main");
	...
	public void setupAnim(OverseerEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch)
	{
		...
		BTAClientUtil.animateHead(root, netHeadYaw, 0.0F);
		BTAClientUtil.animateHead(head.getChild("right_eye"), netHeadYaw, headPitch);
		BTAClientUtil.animateHead(head.getChild("left_eye"), -netHeadYaw, headPitch);
