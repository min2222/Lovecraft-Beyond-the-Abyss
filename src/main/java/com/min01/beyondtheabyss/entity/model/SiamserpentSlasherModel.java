...
public class SiamserpentSlasherModel extends HierarchicalModel<SiamserpentHeadEntity>
{
	...
	public SiamserpentSlasherModel(ModelPart root) 
	{
	...
	@Override
	public void setupAnim(SiamserpentHeadEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch)
	{
		this.root().getAllParts().forEach(ModelPart::resetPose);
		BTAClientUtil.animateHead(this.root.getChild("SiamserpentSlasher"), netHeadYaw, headPitch);
		entity.slashRightAnimationState.animate(this, SiamserpentAnimation.SlasherAnimation.SLASHER_SLASH_RIGHT, ageInTicks);
		entity.slashLeftAnimationState.animate(this, SiamserpentAnimation.SlasherAnimation.SLASHER_SLASH_LEFT, ageInTicks);
		entity.slasherChargeStartAnimationState.animate(this, SiamserpentAnimation.SlasherAnimation.SLASHER_CHARGE_START, ageInTicks);
		entity.slasherChargingAnimationState.animate(this, SiamserpentAnimation.SlasherAnimation.SLASHER_CHARGING, ageInTicks);
		entity.slasherDisabledAnimationState.animate(this, SiamserpentAnimation.SlasherAnimation.SLASHER_DISABLED, ageInTicks);
	}
