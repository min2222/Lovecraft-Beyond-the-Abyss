...
public class SplittedFulgastraModel extends HierarchicalModel<SplittedFulgastraEntity>
{
	...
	public SplittedFulgastraModel(ModelPart root)
	{
	...
	@Override
	public void setupAnim(SplittedFulgastraEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) 
	{
