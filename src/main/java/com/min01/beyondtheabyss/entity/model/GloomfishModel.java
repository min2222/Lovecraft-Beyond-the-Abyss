...
public class GloomfishModel extends HierarchicalModel<GloomfishEntity>
{
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(BeyondtheAbyss.MODID, "gloomfish"), "main");
	private final ModelPart root;

	public GloomfishModel(ModelPart root) 
	{
	...
	@Override
	public void setupAnim(GloomfishEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) 
	{
