...
public class GhidruthModel extends HierarchicalModel<GhidruthEntity>
{
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(BeyondtheAbyss.MODID, "ghidruth"), "main");
	private final ModelPart root;

	public GhidruthModel(ModelPart root)
	{
	...
	public static LayerDefinition createBodyLayer() 
	{
		...
		PartDefinition ghidruth = root.addOrReplaceChild("ghidruth", CubeListBuilder.create(), PartPose.offset(0.0F, 0.0F, 0.0F));

		PartDefinition Head = ghidruth.addOrReplaceChild("Head", CubeListBuilder.create().texOffs(177, 0).addBox(-18.5F, -26.6071F, -85.65F, 37.0F, 18.0F, 53.0F, new CubeDeformation(0.0F))
		.texOffs(260, 82).addBox(-13.5F, -8.6071F, -74.65F, 27.0F, 6.0F, 40.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -19.3929F, 1.04F));
	...
	@Override
	public void setupAnim(GhidruthEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) 
	{
