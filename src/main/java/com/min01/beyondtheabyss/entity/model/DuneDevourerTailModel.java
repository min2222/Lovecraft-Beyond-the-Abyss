...
public class DuneDevourerTailModel extends HierarchicalModel<DuneDevourerTailEntity>
{
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(BeyondtheAbyss.MODID, "dune_devourer_tail"), "main");
	private final ModelPart root;
	private final ModelPart dune_devourer;

	public DuneDevourerTailModel(ModelPart root)
	{
	...
	@Override
	public void setupAnim(DuneDevourerTailEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch)
	{
