...
public class SpineWormHeadModel extends HierarchicalModel<SpineWormHeadEntity>
{
	...
	public SpineWormHeadModel(ModelPart root) 
	{
	...
	@Override
	public void setupAnim(SpineWormHeadEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) 
	{
		this.root().getAllParts().forEach(ModelPart::resetPose);
		BTAClientUtil.animateHead(this.root.getChild("head"), netHeadYaw, headPitch + 90.0F);
		entity.idleAnimationState.animate(this, SpinewormAnimation.SPINEWORM_IDLE, ageInTicks);
