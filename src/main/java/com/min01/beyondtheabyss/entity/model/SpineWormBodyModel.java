...
public class SpineWormBodyModel extends HierarchicalModel<SpineWormBodyEntity>
{
	...
	public SpineWormBodyModel(ModelPart root)
	{
	...
	@Override
	public void setupAnim(SpineWormBodyEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) 
	{
