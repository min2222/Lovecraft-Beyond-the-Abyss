...
public abstract class AbstractBTAWaterCreature extends AbstractAnimatableWaterCreature implements IMultipart
{
	public static final EntityDataAccessor<Vec3> LAST_LOOK_POS = SynchedEntityData.defineId(AbstractBTAWaterCreature.class, BTAEntityDataSerializers.VEC3.get());
	
	public final EntityPartBuilder<? extends AbstractBTAWaterCreature> partBuilder;
	
	public AbstractBTAWaterCreature(EntityType<? extends AbstractAnimatableWaterCreature> pEntityType, Level pLevel)
	{
	...
	public abstract EntityPartBuilder<? extends AbstractBTAWaterCreature> createBuilder();
