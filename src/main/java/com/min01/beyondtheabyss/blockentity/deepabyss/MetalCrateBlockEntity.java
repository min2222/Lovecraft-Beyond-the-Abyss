...
public class MetalCrateBlockEntity extends RandomizableContainerBlockEntity
{
	...
	private ContainerOpenersCounter openersCounter = new ContainerOpenersCounter() 
	{
		...
		{
			MetalCrateBlockEntity.this.playSound(p_155064_, SoundEvents.BARREL_OPEN);
		}

		@Override
		protected void onClose(Level p_155072_, BlockPos p_155073_, BlockState p_155074_)
		{
			MetalCrateBlockEntity.this.playSound(p_155074_, SoundEvents.BARREL_CLOSE);
		}
		...
		protected boolean isOwnContainer(Player p_155060_)
		{
			if(p_155060_.containerMenu instanceof ChestMenu) 
			{
				...
				return container == MetalCrateBlockEntity.this;
			} 
			else 
			{
				return false;
	...
	public MetalCrateBlockEntity(BlockPos p_155630_, BlockState p_155631_)
	{
		super(BTABlocks.METAL_CRATE_BLOCK_ENTITY.get(), p_155630_, p_155631_);
	}
	...
	{
		return Component.translatable("container.metal_crate");
	}
