...
public class ClientEventHandler
{
    ...
    public static void onRegisterEntityRenderers(EntityRenderersEvent.RegisterRenderers event)
    {
    	...
    	event.registerEntityRenderer(BTAEntities.TWINSERPENT_HEAD.get(), TwinserpentSlasherRenderer::new);
    	event.registerEntityRenderer(BTAEntities.TWINSERPENT_BONE.get(), TwinserpentMiddleBoneRenderer::new);
    ...
    public static void onRegisterLayerDefinitions(EntityRenderersEvent.RegisterLayerDefinitions event)
    {
    	...
    	event.registerLayerDefinition(ModelTwinserpentSlasher.LAYER_LOCATION, ModelTwinserpentSlasher::createBodyLayer);
    	event.registerLayerDefinition(ModelTwinserpentBlaster.LAYER_LOCATION, ModelTwinserpentBlaster::createBodyLayer);
    	event.registerLayerDefinition(ModelTwinserpentBone.LAYER_LOCATION, ModelTwinserpentBone::createBodyLayer);
    	event.registerLayerDefinition(ModelTwinserpentMiddleBone.LAYER_LOCATION, ModelTwinserpentMiddleBone::createBodyLayer);
