...
public class BTAEntityDataSerializers 
{
	...
	public static final RegistryObject<EntityDataSerializer<Vec3>> VEC3 = SERIALIZERS.register("vec3", () -> EntityDataSerializer.simple(BTAEntityDataSerializers::writeVec3, BTAEntityDataSerializers::readVec3));
