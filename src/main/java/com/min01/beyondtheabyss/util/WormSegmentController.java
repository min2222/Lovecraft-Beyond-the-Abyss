...
{
	public static void tickForward(LivingEntity living, LivingEntity owner, float distance, float speed)
	{
		float xz = 0.0F;
		float yRot = 0.0F;
		float xRot = 0.0F;
	...
	public static void tick(Entity living, Entity owner, float distance, float speed)
	{
		float xz = 0.0F;
		float yRot = 0.0F;
		float xRot = 0.0F;
