...
public class ModelLargeSkull extends Model
{
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(BeyondtheAbyss.MODID, "large_skull"), "main");
	private final ModelPart largeskull;

	public ModelLargeSkull(ModelPart root) 
	{
