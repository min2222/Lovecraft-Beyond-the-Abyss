	...
	public static void draw(ForgeGui gui, GuiGraphics guiGraphics, float partialTick, int screenWidth, int screenHeight)
	{
		...
		if(!stack.isEmpty())
		{
			if(stack.getItem() instanceof AbstractDivingSetItem item)
			{
		        ...
		        guiGraphics.blit(new ResourceLocation(BeyondtheAbyss.MODID, "textures/gui/oxygen_tank.png"), screenWidth / 2 + posX + 32, screenHeight / 2 + posY + 64, 0, 0, -32, -progress2, 32, 64);
		        RenderSystem.setShaderColor(0.5F, 0.5F, 0.5F, 1.0F);
		        guiGraphics.blit(new ResourceLocation(BeyondtheAbyss.MODID, "textures/gui/anti_oxygen_tank.png"), screenWidth / 2 + posX, screenHeight / 2 + posY, 0, 0, 32, progress, 32, 64);
			}
		}
	}
}
