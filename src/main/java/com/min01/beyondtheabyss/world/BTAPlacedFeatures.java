...
public class BTAPlacedFeatures 
{
	...
	public static final RegistryObject<PlacedFeature> ABYSSALITH_SPIKE = PLACED_FEATURES.register("abyssalith_spike", () -> new PlacedFeature(Holder.hackyErase(BTAConfiguredFeatures.ABYSSALITH_SPIKE.getHolder().get()), List.copyOf(List.of(CountPlacement.of(10), InSquarePlacement.spread(), PlacementUtils.FULL_RANGE, BiomeFilter.biome()))));
}
