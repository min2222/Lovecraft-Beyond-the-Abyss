...
public class BTAPlacedFeatures 
{
	...
	public static final RegistryObject<PlacedFeature> SPINE = PLACED_FEATURES.register("spine", () -> new PlacedFeature(Holder.hackyErase(BTAConfiguredFeatures.SPINE.getHolder().get()), List.copyOf(List.of(CountPlacement.of(5), PlacementUtils.FULL_RANGE, BiomeFilter.biome()))));
	...
	public static final RegistryObject<PlacedFeature> CORAL_TREE = PLACED_FEATURES.register("coral_tree", () -> new PlacedFeature(Holder.hackyErase(BTAConfiguredFeatures.CORAL_TREE.getHolder().get()), List.copyOf(List.of(CountPlacement.of(1), InSquarePlacement.spread(), PlacementUtils.FULL_RANGE, BiomeFilter.biome()))));
	...
	public static final RegistryObject<PlacedFeature> STONE_SPIKE = PLACED_FEATURES.register("stone_spike", () -> new PlacedFeature(Holder.hackyErase(BTAConfiguredFeatures.STONE_SPIKE.getHolder().get()), List.copyOf(List.of(CountPlacement.of(3), InSquarePlacement.spread(), PlacementUtils.FULL_RANGE, BiomeFilter.biome()))));
}
