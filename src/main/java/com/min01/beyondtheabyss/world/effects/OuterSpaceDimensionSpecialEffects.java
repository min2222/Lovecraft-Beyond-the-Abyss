...
public class OuterSpaceDimensionSpecialEffects extends DimensionSpecialEffects
{
	...
	{
		ResourceLocation.fromNamespaceAndPath(BeyondtheAbyss.MODID, "textures/environment/outer_space/death_star.png"),
		ResourceLocation.fromNamespaceAndPath(BeyondtheAbyss.MODID, "textures/environment/outer_space/ice_planet.png"),
		ResourceLocation.fromNamespaceAndPath(BeyondtheAbyss.MODID, "textures/environment/outer_space/living_planet.png"),
		ResourceLocation.fromNamespaceAndPath(BeyondtheAbyss.MODID, "textures/environment/outer_space/magma_planet.png"),
		ResourceLocation.fromNamespaceAndPath(BeyondtheAbyss.MODID, "textures/environment/outer_space/mint_planet.png")
	};
