...
{
	public static final Codec<MirroredCityChunkGenerator> CODEC = RecordCodecBuilder.create((p_224323_) ->
	{
		...
		}))).apply(p_224323_, p_224323_.stable(MirroredCityChunkGenerator::new));
	});
	
	public MirroredCityChunkGenerator(Registry<StructureSet> p_224206_, Registry<NoiseParameters> p_224207_, BiomeSource p_224208_, Holder<NoiseGeneratorSettings> p_224209_) 
	{
