...
public class DeathValleyCarver extends WorldCarver<CanyonCarverConfiguration>
{
	public DeathValleyCarver(Codec<CanyonCarverConfiguration> p_64711_)
	{
		super(p_64711_);
	}
	...
	private double updateVerticalRadius(CanyonCarverConfiguration p_224800_, RandomSource p_224801_, double p_224802_, float p_224803_, float p_224804_)
	{
		...
		return (double) f1 * p_224802_ * (double) Mth.randomBetween(p_224801_, p_224800_.shape.distanceFactor.getMinValue(), p_224800_.shape.distanceFactor.getMaxValue());
	}
