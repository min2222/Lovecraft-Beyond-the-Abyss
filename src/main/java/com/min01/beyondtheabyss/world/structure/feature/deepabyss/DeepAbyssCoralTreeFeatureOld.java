...
public class DeepAbyssCoralTreeFeatureOld extends Feature<NoneFeatureConfiguration>
{
	public DeepAbyssCoralTreeFeatureOld(Codec<NoneFeatureConfiguration> p_65786_)
	{
		super(p_65786_);
	}
