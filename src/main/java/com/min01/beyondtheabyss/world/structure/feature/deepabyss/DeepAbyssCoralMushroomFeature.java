...
public class DeepAbyssCoralMushroomFeature extends AbstractDeepAbyssCoralFeature 
{
	public DeepAbyssCoralMushroomFeature(Codec<NoneFeatureConfiguration> p_65452_) 
	{
		super(p_65452_);
	}
