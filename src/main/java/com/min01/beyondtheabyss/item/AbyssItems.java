...
{
	public static final ArmorMaterial DIVING_ARMOR_MATERIAL = new AbyssArmorMaterial("diver", new int[]{450, 550, 500, 250}, new int[]{3, 5, 4, 2}, 10, SoundEvents.ARMOR_EQUIP_ELYTRA, 0, 0, () -> Ingredient.EMPTY);
	
	public static final ArmorMaterial ADVANCED_DIVING_ARMOR_MATERIAL = new AbyssArmorMaterial("advanced_diver", new int[]{650, 750, 700, 450}, new int[]{4, 6, 5, 3}, 15, SoundEvents.ARMOR_EQUIP_ELYTRA, 1, 0, () -> Ingredient.EMPTY);

	public static final ArmorMaterial GHIDRUTH_DIVING_ARMOR_MATERIAL = new AbyssArmorMaterial("ghidruth_diver", new int[]{1650, 1750, 1700, 1450}, new int[]{14, 16, 15, 13}, 25, SoundEvents.ARMOR_EQUIP_NETHERITE, 15, 0.5F, () -> Ingredient.of(AbyssItems.GHIDRUTH_SCALE.get()));
	
	public static final DeferredRegister<Item> ITEMS = DeferredRegister.create(ForgeRegistries.ITEMS, BeyondtheAbyss.MODID);
	
	//spawn eggs
	public static final RegistryObject<Item> GHIDRUTH_SPAWN_EGG = ITEMS.register("ghidruth_spawn_egg", () -> new ForgeSpawnEggItem(() -> AbyssEntityType.GHIDRUTH.get(), 862018, 10239048, new Item.Properties().tab(BeyondtheAbyss.ABYSS_MOBS)));
