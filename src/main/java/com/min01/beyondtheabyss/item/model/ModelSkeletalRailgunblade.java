...
import com.min01.beyondtheabyss.item.animation.SkeletalRailgunbladeAnimation;
...
public class ModelSkeletalRailgunblade extends HierarchicalItemModel
{
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(BeyondtheAbyss.MODID, "skeletal_railgunblade"), "main");
	private final ModelPart root;
	private final ModelPart SkeletalGunblade;
	private final ModelPart Blade;
	private final ModelPart EnergyRay;

	public ModelSkeletalRailgunblade(ModelPart root)
	{
	...
	{
		//FIXME too fast for some reason;
