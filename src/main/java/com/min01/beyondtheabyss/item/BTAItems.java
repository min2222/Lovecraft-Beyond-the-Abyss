...
public class BTAItems 
{
	...
	public static final RegistryObject<Item> BLASTER_SKULL = ITEMS.register("blaster_skull", () -> new Item(new Item.Properties().tab(DeepAbyssTabs.ABYSS_MATERIALS)));
	public static final RegistryObject<Item> SERPENT_HEART = ITEMS.register("serpent_heart", () -> new Item(new Item.Properties().tab(DeepAbyssTabs.ABYSS_MATERIALS)));
