...
public class SkeletalRailgunbladeAnimation
{
	public static final AnimationDefinition RAILGUNBLADE_OPEN = AnimationDefinition.Builder.withLength(1.0F)
		...
		public static final AnimationDefinition RAILGUNBLADE_CLOSED = AnimationDefinition.Builder.withLength(0.0F)
			.addAnimation("Skull", new AnimationChannel(AnimationChannel.Targets.ROTATION, 
				new Keyframe(0.0F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR)
			))
			.addAnimation("Skull", new AnimationChannel(AnimationChannel.Targets.POSITION, 
		...
		public static final AnimationDefinition RAILGUNBLADE_OPENED = AnimationDefinition.Builder.withLength(0.0F)
			.addAnimation("Skull", new AnimationChannel(AnimationChannel.Targets.ROTATION, 
				new Keyframe(0.0F, KeyframeAnimations.degreeVec(-20.5F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR)
			))
			.addAnimation("Horn", new AnimationChannel(AnimationChannel.Targets.ROTATION, 
